  ...
  class ThreeDStage extends HTMLElement {
    ...
    async _boot() {
      ...
      const [THREE, controlsMod] = await Promise.all([
        ...
        import('https://unpkg.com/three@0.184.0/examples/jsm/controls/OrbitControls.js'),
      ]);
      this._THREE = THREE;
    ...
    async _exportObj() {
      if (!this._object) return;
      const mod = await import('https://unpkg.com/three@0.184.0/examples/jsm/exporters/OBJExporter.js');
    ...
    async _exportGlb() {
      if (!this._object) return;
      const mod = await import('https://unpkg.com/three@0.184.0/examples/jsm/exporters/GLTFExporter.js');
      this._nameParts();
      const base = this._basename;
